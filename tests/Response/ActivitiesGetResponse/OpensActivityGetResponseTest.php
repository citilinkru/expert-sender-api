...
/**
 * OpensActivityGetResponseTest
 *
 * @author Nikita Sapogov <sapogov.n@citilink.ru>
 */
class OpensActivityGetResponseTest extends \PHPUnit_Framework_TestCase
{
    /**
     * Test
     */
...
2017-06-01 11:52:00,ps@gmail.ru,226,"Subject",151,Some action,67331a21-a384-4215-bede-019112548619';
        ...
        $response = new OpensActivityGetResponse(
            new Response(
        ...
        /** @var OpenActivity[] $sends */
        $sends = toArray($response->getOpens());
